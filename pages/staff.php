...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO staff (name, course, highest_level, employee_no, phone, email, section) VALUES (?, ?, ?, ?, ?, ?, ?)");
    if ($stmt) {
...
<head>
    ...
    <title>Non-Teaching Staff Management</title>
...
<body class="bg-gray-100 p-6">
    <div class="container mx-auto max-w-6xl">
        <h1 class="text-3xl font-bold text-blue-800 mb-6">Non-Teaching Staff Management</h1>
        ...
        <div id="popover-form" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div class="bg-white rounded-lg shadow-lg w-96 max-h-screen overflow-y-auto p-6">
                <h2 class="text-xl font-bold text-blue-700 mb-4">Add Information</h2>
                <form method="POST">
                    <div class="mb-4">
